...
% -----------------------------------------------------------------
\titulo{Desenvolvimento de Um Jogo para Auxiliar a Educação Financeira nas Escolas}%
...
\instituicao{Universidade do Estado de Santa Catarina, Centro de , Programa de Pós--Graduação em Engenharia Elétrica}%
